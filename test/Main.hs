...
helpersTests =
  testGroup
    ...
    , testCase "inferStyle covers known forms" do
        inferStyle "です" @?= Just (MkStyle Formal NonPast)
        inferStyle "でした" @?= Just (MkStyle Formal Past)
        inferStyle "行きます" @?= Just (MkStyle Formal NonPast)
        inferStyle "行きました" @?= Just (MkStyle Formal Past)
        inferStyle "だ" @?= Just (MkStyle Casual NonPast)
        inferStyle "だった" @?= Just (MkStyle Casual Past)
